...
<rapid:override name="content">
    ...
    <form class="layui-form"  method="post" id="myForm" action="/SSMBlog/admin/article/insertSubmit">

        <div class="layui-form-item">
            <label class="layui-form-label">标题 <span style="color: #FF5722; ">*</span></label>
            <div class="layui-input-block">
                <input type="text" name="article_title" lay-verify="title" id="title" autocomplete="off" placeholder="请输入标题" class="layui-input">
            </div>
        </div>
        ...
        <div class="layui-form-item layui-form-text">
            ...
            <div class="layui-input-block">
                <textarea class="layui-textarea layui-hide" name="article_content" lay-verify="content" id="content"></textarea>
            </div>
        ...
        <div class="layui-form-item" pane="">
            ...
            <div class="layui-input-block">
                <c:forEach items="${tagList}" var="t">
                    <input type="checkbox" name="articleTagIds" lay-skin="primary" title="${t.tag_name}" value="${t.tag_id}">
                </c:forEach>
            </div>
        </div>
        <div class="layui-form-item">
        ...
        layui.use(['form', 'layedit', 'laydate'], function() {
            ...
            form.on("select(articleParentCategoryId)",function () {
                ...
                if(articleParentCategoryId==${c.category_pid}) {
                    optionstring += "<option name='childCategory' value='${c.category_id}'>${c.category_name}</option>";
                }
                </c:forEach>
