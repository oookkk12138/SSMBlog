...
<rapid:override name="content">
    ...
    <br><br>
    <form class="layui-form" action="/SSMBlog/admin/user/insertSubmit" id="userForm"
          method="post">
        <div class="layui-form-item">
            ...
            <input type="hidden" name="user_avator" id="userAvatar" value="">
        </div>
        <div class="layui-form-item">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="password" name="user_password"  id="userPass" required
                       lay-verify="userPass"
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="url" name="user_url"  placeholder=""
                       class="layui-input">
            </div>
        </div>
