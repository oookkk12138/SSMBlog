...
<rapid:override name="content">
    ...
    <div class="layui-row">
        <div class="layui-col-md4">
            <form class="layui-form"  method="post" id="myForm" action="/SSMBlog/admin/tag/insertSubmit">
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        ...
                        <input type="text" name="tag_name" placeholder="请输入标签名称" autocomplete="off" class="layui-input" required>
                    </div>
                    <br>
                    <div class="layui-input-block">
                        标签描述
                        <input type="text" name="tag_description" placeholder="请输入标签描述" autocomplete="off" class="layui-input" >
                    </div>
                    <br>
                    <div class="layui-input-block">
            ...
            <table class="layui-table" >
                ...
                <c:forEach items="${tagList}" var="c">
                    ...
                    <tr>
                        ...
                        <td >
                            <a href="/SSMBlog/home/articleListByTag/${c.tag_id}" lay-data="{sort:true}">${fn:length(c.articleList)}</a>
                        </td>
                        <td>
