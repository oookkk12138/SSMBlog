    ...
    <nav class="breadcrumb">
        ...
        <c:choose>
            <c:when test="${tag != null}">
                <a href="/SSMBlog/home/articleListByTag/${tag.tag_id}">${tag.tag_name}</a>
                    ...
                    <c:forEach items="${articleList}" var="a">
                        ...
                        <article class="post">
                            ...
                            <figure class="thumbnail">
                                ...
                                <span class="cat">
                                     <a href="/SSMBlog/home/articleListByCategory/${a.categoryList[0].category_id}">${a.categoryList[0].category_name}</a>
                                </span>
                            </figure>
