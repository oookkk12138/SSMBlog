...
<head>
    ...
    <link rel="shortcut icon" href="/SSMBlog/resource/upload/logo.png">
    <rapid:block name="description">
        <meta name="description" content="${staticOption.option_meta_description}"/>
    </rapid:block>
    <rapid:block name="keywords">
        <meta name="keywords" content="${staticOption.option_meta_keyword}"/>
    </rapid:block>
    <rapid:block name="title">
        <title>
                ${staticOption.option_site_title}-${staticOption.option_site_description}
        </title>
    </rapid:block>
    <link rel="stylesheet" href="/SSMBlog/resource/css/style.css">
...
<script src="/SSMBlog/resource/js/superfish.js"></script>
<script src='/SSMBlog/resource/js/sticky.js'></script>
<script src="/SSMBlog/resource/js/script.js"></script>
